...
export const ExperienceTime = ({ initial, final, className, ...props }: ExperienceTimeProps) => {
	...
	return (
		<p className={twMerge('text-xs font-medium text-white md:text-base', className)} {...props}>
			{experienceTime}
		</p>
	)
}
